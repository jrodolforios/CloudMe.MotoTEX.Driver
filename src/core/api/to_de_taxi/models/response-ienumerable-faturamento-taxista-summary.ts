...
import { FaturamentoTaxistaSummary } from './faturamento-taxista-summary';
export interface ResponseIEnumerableFaturamentoTaxistaSummary {
   ...
   */
  data?: Array<FaturamentoTaxistaSummary>;
